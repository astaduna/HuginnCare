    ...
    const handleLogin = async () => {
        if (!isEmpty) {
            try {
                ...
                if (isLoggedIn) {
                    // Assuming submit is a prop function that you call after successful login
                    submit(true);
                } else {
        ...
        <KeyboardAvoidingView
            ...
            <View style={styles.container}>
                ...
                <TextInput
                    ...
                    value={username}
                    onChangeText={setUsername} // Simplified for brevity
                />
                <TextInput
                    style={styles.textInput}
                    ...
                    value={password}
                    onChangeText={setPassword} // Simplified for brevity
                />
